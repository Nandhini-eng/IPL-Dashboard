...
const Skeleton = () => (
  <div className="animate-pulse p-4 rounded-lg bg-gray-100 shadow-md w-full max-w-md mx-auto">
...
const MatchBanner: React.FC<MatchBannerProps> = ({ match }) => {
  ...
  return (
    <div className="p-4 rounded-lg bg-white shadow-md w-full max-w-md mx-auto mt-4 flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-gray-800">
          {match.teamA} <span className="text-gray-500 font-normal">vs</span>{" "}
          {match.teamB}
        </h2>
        <span
